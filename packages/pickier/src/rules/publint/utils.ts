...
const ESM_CONTENT_RE = new RegExp(
  '(?:[\\s' + ';' + ']|^)(?:import[\\w,{}\\s*]*from|import\\s*[\'"*{]|export\\b\\s*(?:[*{]|default|type|function|const|var|let|async function)|import\\.meta\\b)',
  'm',
)
const CJS_CONTENT_RE = new RegExp(
  '(?:[\\s' + ';' + ']|^)(?:module.exports\\b|exports\\.\\w|require\\s*\\(|global\\.\\w|Object\\.(?:defineProperty|defineProperties|assign)\\s*\\(\\s*exports\\b)',
  'm',
)
